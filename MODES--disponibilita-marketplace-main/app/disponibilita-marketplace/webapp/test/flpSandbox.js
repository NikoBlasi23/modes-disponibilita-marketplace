		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Disponibilità Marketplace",
									"targetURL": "#disponibilitamarketplace-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"disponibilitamarketplace-display": {
								"semanticObject": "disponibilitamarketplace",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=disponibilitamarketplace",
									"url": sap.ui.require.toUrl("disponibilitamarketplace")
								}
							}
						}
					}
